                     ...
                     radix_sort_vk_target_t const * target)
{
  ...
  //
  radix_sort_vk_t * const rs = reinterpret_cast<radix_sort_vk_t*>(MALLOC_MACRO(sizeof(*rs)));
...
#define RS_SUBGROUP_SIZE_CREATE_INFO_NAME(name_)                                                   \
  RS_SUBGROUP_SIZE_CREATE_INFO_SET(1u << rs_target_header->config.name_.subgroup_size_log2)
